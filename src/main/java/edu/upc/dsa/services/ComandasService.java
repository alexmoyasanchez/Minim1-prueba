...
public class ComandasService {
    ...
    @GET
    @ApiOperation(value = "(1) get productosByPrice ascendente", notes = "asdasd")
    @ApiResponses(value = {
    ...
    @GET
    @ApiOperation(value = "(4) GET all pedidos por usuario (4)", notes = "asdasd")
    @ApiResponses(value = {
    ...
    @GET
    @ApiOperation(value = "(5) get productosBySells descendente", notes = "asdasd")
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Successful", response = Producto.class, responseContainer = "List"),
    })
    @Path("/ventasDesc")
    ...
    @ApiOperation(value = "(OTHER) Create a new User", notes = "asdasd")
    @ApiResponses(value = {
